...
CREATE TABLE IF NOT EXISTS `states` (
  `device` bigint(20) NOT NULL,
  `timestamp` bigint(20) NOT NULL,
  `state` set('Standby','Manual','Demand','Week program','Servo-flow','Away','Summer','DI Override','Hygrostat override','Fireplace','Installer','Fail Safe 1','Fail Safe 2','Fail Off','Defrost Off','Defrost','Night') NOT NULL,
